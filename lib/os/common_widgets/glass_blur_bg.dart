  ...
  Widget build(BuildContext context) {
    ...
    return ClipRRect(
      child: BackdropFilter(
        filter: ImageFilter.blur(sigmaX: isDark ? 100 : 50, sigmaY: isDark ? 100 : 50),
        child: Stack(
          children: [
            if (isDark)
            Positioned.fill(
            ...
            Positioned.fill(
                child:
                    Container(color: isDark ? const Color(0xFF373737).withOpacity(.4) : const Color(0xFFFFFFFF).withOpacity(.8))),
            Positioned.fill(
              child: Opacity(
                opacity: 0.02,
                child: Image.asset(
